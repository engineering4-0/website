...
const EventsPage = () => {
  ...
  const pastEvents = [
    ...
    {
      images: [event_2_6, event_2_1, event_2_2, event_2_3, event_2_4, event_2_5],
      title: "Welcome Event 👋",
      // subHeading: "this is sub heading",
  ...
  return (
    <div style={{ backgroundImage: `url(${background})`, lightingColor: "50%" }}>
          ...
          <>
            ...
            <section className="eventsTimeline">
              {upcomingEvents.map((event, index) => (
                <div
                  className={`eventCardContainer ${(index + 1) % 2 === 0 ? "right" : ""}`}
                  key={index}
        ...
        <section className="eventsTimeline">
          {pastEvents.map((event, index) => (
            ...
            >
              ...
              <div className="content-wrapper">
                <h2 className="eventHeading">{event.title}</h2>
                {event.subHeading && <h3 className="eventSubHeading">{event.subHeading}</h3>}
                <div className="locationAndTimeContainer">
                  <span className="location">{event.location}</span>
                  <span className="time">{event.time}</span>
                </div>
